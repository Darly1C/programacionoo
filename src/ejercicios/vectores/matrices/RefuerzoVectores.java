package ejercicios.vectores.matrices;

public class RefuerzoVectores {
...
//5. Declara un vector Z(12) y asignar a todas sus posiciones valores que inician 
...
//7. Declara un vector H(10) y asignar solo a las posiciones impares letras 
...
// en la última posición el valor de 20/4
		...
		N[0] = ((3 + 10 + 9) / 3);
		N[4] = (7 + 8 + 10);
		N[12] = (5 * 7 * 3);// N[12] no existe
		N[20] = ((7 + 8) - 3);// N[20] no existe
		N[11] = (20 / 4);
