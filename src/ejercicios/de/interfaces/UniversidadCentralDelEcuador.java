...
public class UniversidadCentralDelEcuador implements MatriculaInterfaz{
	...
	public void solicitarIdentificacionEstudiante(String cedula, String nombre, String apellido, int edad) {
		...
		System.out.println("Confirmar información del estudiante en la base de datos de la Universidad Central del Ecuador");
	...
	public void solicitarHistorialAcademico() {
		// TODO Auto-generated method stub
		System.out.println("Solicitar historial académico de la Universidad Central del Ecuador");
